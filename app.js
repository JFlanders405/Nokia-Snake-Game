document.addEventListener("DOMContentLoaded", () => {
  ...
  let currentSnake = [2, 1, 0]; // div in grid being 2 for the HEAD, 0 being the TAIL, all 1's being the body for now on
  ...
  function moveOutcomes() {
    ...
    if (
      ...
      return clearInterval(interval); //this will clear the interval if above happen
    }
  ...
  function randomApple() {
    ...
    } while (squares[appleIndex].classList.contains("snake")); //making sure apple does not appear in any divs
  ...
  function control(e) {
    ...
    if (e.keyCode === 39) {
      ...
      direction = +width; //if we press down, the snake head will instant appear in the div ten divs from where you are now
    }
  }
